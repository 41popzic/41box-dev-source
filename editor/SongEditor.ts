...
export class SongEditor {
    ...
    private readonly _tempoSlider: Slider = new Slider(input({ style: "margin: 0; vertical-align: middle;", type: "range", min: "1", max: "100", value: "160", step: "1" }), this.doc, (oldValue: number, newValue: number) => new ChangeTempo(this.doc, oldValue, newValue), false);
    ...
    private readonly _pulseWidthDropdownGroup: HTMLElement = div({ class: "editor-controls-alt", style: "display: none;" }, this._decimalOffsetRow);
    ...
    private readonly _unisonDropdownGroup: HTMLElement = div({ class: "editor-controls-alt", style: "display: none; gap: 3px; margin-bottom: 0.5em;" }, this._unisonVoicesRow, this._unisonSpreadRow, this._unisonOffsetRow, this._unisonExpressionRow, this._unisonSignRow);
    ...
    private readonly _envelopeDropdownGroup: HTMLElement = div({ class: "editor-controls-alt", style: "display: none;" }, this._envelopeSpeedRow);
    ...
    private readonly _drumsetGroup: HTMLElement = div({ class: "editor-controls-alt" });
    ...
    */
    ...
    constructor(/*private _doc: SongDocument*/) {
        ...
        /*window.addEventListener("contextmenu", (event) => {
            ...
            const tabElement = target.closest(".song-tab") as HTMLElement | null;
        ...
        if (promptName) {
            switch (promptName) {
                ...
                case "configureShortener":
                    ...
                    break;
                case "preferences":
                    this.prompt = new PreferencesPrompt(this.doc, this._patternEditor, this._trackArea, document.getElementById("beepboxEditorContainer")!);
                    break;
    ...
    public whenUpdated = (): void => {
        ...
        this._rhythmInput.value = Config.rhythms[this.doc.song.rhythm].stepsPerBeat.toString();
    ...
    private _whenSetRhythmInput = (): void => {
        const desiredSteps = Number(this._rhythmInput.value);

        if (isNaN(desiredSteps) || desiredSteps < 1) return;
        ...
        for (let i = 0; i < Config.rhythms.length; i++) {
            const difference = Math.abs(
                Config.rhythms[i].stepsPerBeat - desiredSteps
            );
