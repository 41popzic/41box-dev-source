...
import { FilterType, EnvelopeType, EnvelopeComputeIndex, Transition, Envelope, AutomationTarget, Config, getArpeggioPitchIndex, LFOEnvelopeTypes, RandomEnvelopeTypes } from "./SynthConfig";
