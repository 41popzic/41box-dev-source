        ...
        while (charIndex < compressed.length) switch (command = compressed.charCodeAt(charIndex++)) {
            ...
            case SongTagCode.unison: {
                if (beforeThree && fromBeepBox) {
                    ...
                    const unisonLength = from41Box ? (beforeThree ? 49 : b  eforeFive ? 49 : Config.unisons.length) : fromSlarmoosBox ? (beforeFive ? 27 : Config.unisons.length) : Config.unisons.length;
